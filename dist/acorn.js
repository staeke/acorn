(function (global, factory) {
  ...
  pp$3.parseExprAtom = function(refDestructuringErrors, noDynamicImport) {
  ...
  pp$3.parseExprImport = function(noDynamicImport) {
    var node = this.startNode();
  ...
  pp$3.parseDynamicImport = function(node) {
    ...
    // Verify ending.
    var commaPos = this.start;
    var commaExists = this.eat(types.comma);
